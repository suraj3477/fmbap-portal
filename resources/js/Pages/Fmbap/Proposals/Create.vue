...
const submit = () => {
    form.post(route('fmbap.proposals.store'), {
        onSuccess: () => {
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <textarea v-model="form.scheme_name" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required placeholder="Enter scheme name (can be multi-line or long)"></textarea>
